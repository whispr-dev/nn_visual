...
class AnalogNeuralNetwork:
    def __init__(self):
        ...
        # Add injection values for click interactions
        self.injected = {
            'inputs': np.zeros(4),
            'layer1': np.zeros(2),
            'output': np.zeros(1)
        ...
        # Decay rate for injected signals
    ...
    def forward(self, time):
        ...
        # Generate base oscillating inputs + injected values
    ...
    def inject_signal(self, layer, index, strength=50):
        """Inject a signal into a specific neuron"""
...
class NeuralNetworkVisualizer:
    ...
    def find_closest_node(self, click_x, click_y):
        ...
        # Only return if click is close enough (0.1 units)
